"use strict";
const _i = ['Phigros Simpled EUI', [1, 5, 5, 7, 3], 1611795955, 1652747710];
const urls = {
...
function qwqdraw3(statData) {
	...
	ctxos.fillText(statData.newBestStr, 1000, 500+50);
	ctxos.fillStyle = "#fff";
	ctxos.textAlign = "center";
	ctxos.fillText(statData.scoreBest, 1000+100*2, 500+50);
	ctxos.globalAlpha = range((qwqEnd.second - 1.87) * 2.50);
	ctxos.textAlign = "right";
	ctxos.fillText(statData.scoreDelta, 1000+100*2.5, 500+50);
	...
	ctxos.fillText(statData.textBelowStr, 1000, 500-75);
	ctxos.fillStyle = "#fff";
	ctxos.textAlign = "center";
