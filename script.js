...
function qwqdraw3(statData) {
	...
	const qwq3 = range((qwqEnd.second - 1.87) * 2.14) * 164+72;
	...
	ctxos.drawImage(res["Ranks"][stat.rankStatus], 919*1.325, 100*3.325, qwq3, qwq3);
	//各种数据
	...
	ctxos.fillText(stat.accStr, 352*3.425, 545*1.35);
        ctxos.textAlign = "left";
	ctxos.fillText(stat.maxcombo, 1528*0.65, 545*1.125);
