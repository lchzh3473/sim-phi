...
function getChartOffset(id) {
  if (id === 'c816f8cf-c9b1-492d-a00e-305baae23529') return 200; // 19
  if (id === '0c811469-4645-40f7-88a1-fa7503febbb3') return -50; // 21
  if (id === '026c8905-6f24-421c-a594-e5f9bf1d053a') return 150; // 27
  if (id === '71acb2d4-225e-4b0a-989c-660f4c075542') return 175; // 29
  if (id === '165119b8-7074-4106-bb23-27a8fb99c0c6') return 150; // 30
  if (id === 'ff014085-2845-49dd-837b-b6541a0cc8d0') return 50; // 33
  if (id === '8c4d638a-a1aa-4e29-a0d2-2f3a2cb7e69c') return 300; // 34
  if (id === 'f0b1e2eb-f7f8-42ec-bcb3-6a717147ad4e') return 225; // 35
  if (id === '18686678-cd3b-493e-accb-c6ca0bc304c5') return -50; // 38
  if (id === '0ebddbc4-ff08-4484-8f21-bd0295526bdc') return 50; // 40
  if (id === '430a4ff2-e9e2-4add-9ee4-fbc172367e5d') return 200; // 43
  if (id === '260d12cf-847a-4773-aaf0-b754753f5596') return 75; // 47
  if (id === 'fb716191-ffb4-462b-b92d-85c86f94833e') return -200; // 63
  if (id === 'b15f2eb5-d9c1-40f7-9bc8-4ccbc69229c6') return 200; // 64
  if (id === '710750c5-3728-46b8-bfb2-f895f1f909c0') return 350; // 66
  if (id === '0108b4f0-d3ee-47a0-b6a1-bddcfad8f54d') return 400; // 67
  if (id === '7be304a2-74cc-48a7-80bb-98de40cd814d') return -25; // 73
  if (id === '8747c9b5-9029-499d-b1d5-59bd46e2522f') return 150; // 77
  if (id === '5201e181-b5d1-4931-9785-e78cbed0758e') return 50; // 84
  if (id === '0ada5f8d-7f1d-426e-b53d-747d4489e255') return 100; // 86
  if (id === 'ccf6522f-d746-4b76-9b3b-09d6534fd99e') return 50; // 90
  if (id === '5d17fa22-51da-48e3-b56d-29ed782d830b') return 175; // 92
  if (id === 'e15c5743-fbb1-4d36-9821-43208a75bf07') return 100; // 96
  if (id === '846587d2-0ff2-40ca-b42b-3568cef08e48') return 250; // 98
  if (id === '67b8c0fd-4879-41e3-af04-6dc8f41ddcd1') return -500; // 99
  if (id === '2eb9e940-4350-4509-a244-068abd937f44') return 50; // 102
  if (id === '74585cab-6b6f-4633-9c3d-4dfa9900cafd') return -100; // 103
  if (id === 'f2398611-f145-45f5-b4f9-78be5f97fa86') return 175; // 105
  if (id === '1476dcb7-37c8-4f97-b039-7e07a8583078') return 50; // 106
  if (id === '4be75ae5-af61-4e2b-a23c-7171d063c391') return 300; // 107
  if (id === '9d01431f-7c81-4fb5-a9a4-5f5ef4e07cd3') return 175; // 108
  if (id === 'a7b12a21-cb2c-4e79-9260-2cc3323752df') return -400; // 109
  if (id === 'e7ab7d3b-1be4-4300-b9d6-63814faa381c') return 150; // 110
  if (id === '2b8217af-3c7b-44b2-a9c9-fe869ea17c07') return 50; // 111
  if (id === 'cfab519d-794d-4791-8881-969b00c60b46') return 150; // 112
  if (id === '5230368a-0764-4d17-8673-23c3b5a995d8') return 150; // 113
  if (id === 'cb3a921a-9b7c-4653-87e8-692534d9c87d') return 200; // 114
  if (id === '108254a0-a756-4200-8391-1f47bb7707aa') return -50; // 115
  if (id === 'e4307062-420a-49a2-8515-b22375e7f6c4') return -50; // 117
  if (id === 'e29e6b87-796f-4518-ac33-d9db79bbc103') return 200; // 118
  if (id === 'c4dc62c4-7bed-4f39-b6ed-451ecdcb9b6b') return 250; // 119
  if (id === '7457a0a7-5d50-4e5e-b5a5-6049100a168e') return 200; // 121
  if (id === 'af635f4b-df9c-42ad-9f8d-e20c0e2aebad') return 400; // 122
  if (id === '53e2ca24-2212-4795-be30-1a80cebbc339') return 250; // 123
  if (id === 'd7ad0802-22e1-4efc-8bba-4cfe074d2a95') return 200; // 127
  if (id === 'acab357e-ac69-4e8c-88b4-f8a080560c52') return -400; // 128
  if (id === 'ed0d5555-7573-4b9d-a491-b22aeab66da7') return 200; // 129
  if (id === '918a8854-04be-47e3-bfae-62699d193fee') return 200; // 130
  if (id === '232ec440-647e-4319-96c2-17e97f4ea55d') return 150; // 134
  if (id === '11eae627-ff9e-48fe-8c9f-2d49d6e34221') return -100; // 135
  if (id === '79a029ad-1579-44d2-8ed2-f2c7cc8c6589') return -200; // 136
  if (id === '20bec844-02b8-49e3-8c60-8bf8b8a36a96') return 200; // 137
  if (id === 'e5e9021d-9254-408d-8629-795849f51732') return 75; // 140
  if (id === '39a834ed-7310-46ac-99e4-577cde527a84') return -150; // 141
  if (id === 'da8533af-9767-47b0-87c0-c12684e02980') return -1450; // 144
  if (id === '97e22151-1cb8-4c48-8af4-c3419ed6b9ce') return 175; // 146
  if (id === '8d3c6775-9091-45bd-b6ff-d556cf36e85f') return -350; // 147
  if (id === 'b788d213-58e1-448f-8412-cebe8c8df12a') return 50; // 149
  if (id === '336b6099-61c1-403b-b226-483afc4a7bec') return 25; // 150
  if (id === '04181380-bdcf-40f3-8ec7-68a23ad84ba3') return 50; // 152
  if (id === '920506fb-2c52-4d17-b7e7-d8f1fe6afde5') return 225; // 153
  if (id === '594e3208-8459-48ae-88e8-b11823e5c2ad') return 250; // 154
  if (id === '84f0ce5f-b894-4db6-b042-b31232c62d0c') return -150; // 155
  if (id === '70c543f8-97c5-4a2d-82ff-17efc484d52f') return 400; // 157
  if (id === 'd12f18e4-ca64-4781-97ee-a7d922c831cf') return 50; // 159
  if (id === 'a837eea9-b4a3-4c77-b7e5-757f4e940307') return 150; // 163
  if (id === 'e59e5ef8-d444-4dc6-aebe-44bfd4891a94') return -50; // 164
  if (id === '0a42b7b5-8a25-4438-b221-c9c0e585f27c') return -25; // 165
  if (id === 'fbd4ca74-40c3-4c9f-9415-729f47d537fb') return -25; // 166
  if (id === 'c2006c12-e1c2-47ba-8292-c6c00b37dfbf') return 50; // 171
  if (id === '2b0338d9-e71a-40fe-8d79-dc8f6dec48da') return 50; // 172
  // handled up to 174
  return 0;
}
